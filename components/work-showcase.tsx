...
const topRowProjects = [
  ...
  { id: 3, name: "AV Fitness (Alt)", image: "/images/work/av-fitness-2.png", url: "#" },
  ...
  { id: 6, name: "K Fitness (Alt)", image: "/images/work/k-fitness-2.png", url: "#" },
]
...
const bottomRowProjects = [
  ...
  { id: 9, name: "Regain Clinic", image: "/images/work/regain-clinic-1.png", url: "#" },
  { id: 10, name: "Regain Clinic (Alt)", image: "/images/work/regain-clinic-2.png", url: "#" },
    ...
    <section id="work" className="py-32 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 mb-16">
        ...
        <p className="text-muted-foreground mt-4 max-w-2xl">
          Websites and digital experiences we have built for our clients. Click to explore each project.
        </p>
      </div>
